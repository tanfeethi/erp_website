        ...
        <div className="relative z-10 flex flex-col gap-10">
          ...
          >
            <div className="space-y-4">
              <img
                src="/assets/ERPWhite.webp"
                alt="ERPWhite.webp"
                className="w-24 h-14"
              />
              <p className="text-sm leading-relaxed">
                تحكّم في جميع جوانب عملك من مكان واحد، مع نظام إدارة متكامل يوفر
                لك أدوات متطورة لإدارة الموظفين، متابعة المهام، تتبع الأداء،
                وإصدار التقارير الذكية، مما يضمن لك الكفاءة، النمو، واستمرارية
                أعمالك بكل سهولة واحترافية
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/systems" className="link link-hover">
                    {t("systems")}
                  </Link>
                </li>
                <li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <Link to={"mailto:info@jecerpsa.sa"}>info@jecerpsa.sa</Link>
                </li>
                <li className="flex items-start gap-2">
                  <FaPhone className="mt-1" />
                  <Link to={"tel:0554098883"}>0554098883</Link>
                </li>
                <li className="flex items-start gap-2">
            ...
            <div className="space-y-4">
              <h3 className="font-bold">{t("subscribeTitle")}</h3>
              <input
                type="email"
          ...
          >
            ...
            <div className="flex gap-3">
              {[FaInstagram, FaLinkedin, FaFacebook].map((Icon, index) => (
                <div
                  key={index}
                  className="bg-[#FCFCFC] p-2 rounded border border-gray-300"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center text-xs text-white">
            ...
            <div className="text-center">{t("copyright")} 2025 JEC ERP ©.</div>
